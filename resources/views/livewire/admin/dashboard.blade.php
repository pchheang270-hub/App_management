    ...
    <div class="flex-1 p-8 overflow-auto mt-6 ml-6"> {{-- added margin --}}
        ...
        <div class="mb-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div
                    class="bg-white rounded-lg p-6 border-2 border-green-100 shadow-md transform transition duration-300 ease-in-out">
                ...
                <div
                    class="bg-white rounded-lg p-6 border-green-100 shadow-md transform transition duration-300 ease-in-out">
                    <div class="flex items-center">
            ...
            <div class="flex gap-4 justfy-center">
                ...
                <button wire:click="checkIn
                    class="flex items-center gap-2 bg-green-500
                    hover:bg-green-600 text-white py-2 px-4 rounded-lg shadow">
                    ✅ Check-In
                </button>
                <button wire:click="checkOut"
                    class="flex items-center gap-2 bg-red-600 hover:bg-red-600 text-white py-2 px-4 rounded-lg shadow">
                    ⛔ Check-Out
                </button>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2 border">{{ $attendance->check_out ?? '-' }}</td>
                            </tr>
                        </thead>
