    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <form wire:submit.prevent="register" class="mt-8 space-y-6">
            <div class="space-y-4">
                ...
                <div>
                    <label for="position" class="block mb-1 text-gray-700 font-medium">Position</label>
                    <input wire:model="position" type="text" required 
                           class="w-full px-3 py-2 border border-gray-300 
                           placeholder-gray-500 text-gray-900 rounded-md 
                           focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" 
                ...
                <div>
                    ...
                    <select wire:model="role" class="w-full px-3 py-2 border
